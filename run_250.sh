...
# Run the pipeline for all models with KMeans scorer and Budget 250

set -e

CONFIG="config_250.yaml"
OUTPUT_DIR="output250"

echo "=========================================="
echo "KMeans Scorer | Budget: 250"
echo "Config: $CONFIG"
...
echo ""
echo "KMeans Budget 250 - All models processed successfully!"
