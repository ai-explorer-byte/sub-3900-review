...
# Run the pipeline for all models with Coreset scorer and Budget 1500

set -e

CONFIG="config_coreset_1500.yaml"
OUTPUT_DIR="output_coreset1500"

echo "=========================================="
echo "Coreset Scorer | Budget: 1500"
echo "Config: $CONFIG"
...
echo ""
echo "Coreset Budget 1500 - All models processed successfully!"
